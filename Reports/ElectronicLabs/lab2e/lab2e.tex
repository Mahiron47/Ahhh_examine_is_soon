...
\def\BJTName{$2$N$2712$}
\def\JFETName{$2$N$5558$}
...
% Строка IК1(при IБ1)
\def\IkOneUoThree{\fpeval{628.776 * 10^{-6}}} % IК1 при UКЭ = 0.3 В, мА
\def\IkOneUone   {\fpeval{639.384 * 10^{-6}}} % IК1 при UКЭ = 1 В, мА
\def\IkOneUthree {\fpeval{661.266 * 10^{-6}}} % IК1 при UКЭ = 3 В, мА
\def\IkOneUfive  {\fpeval{683.022 * 10^{-6}}} % IК1 при UКЭ = 5 В, мА
\def\IkOneUseven {\fpeval{706.044 * 10^{-6}}} % IК1 при UКЭ = 7 В, мА
\def\IkOneUten   {\fpeval{739.001 * 10^{-6}}} % IК1 при UКЭ = 10 В, мА

% Строка IК2(при IБ2)
\def\IkTwoUoThree{\fpeval{2.087 * 10^{-3}}} % IК2 при UКЭ = 0.3 В, мА
\def\IkTwoUone   {\fpeval{2.126 * 10^{-3}}} % IК2 при UКЭ = 1 В, мА
\def\IkTwoUthree {\fpeval{2.199 * 10^{-3}}} % IК2 при UКЭ = 3 В, мА
\def\IkTwoUfive  {\fpeval{2.272 * 10^{-3}}} % IК2 при UКЭ = 5 В, мА
\def\IkTwoUseven {\fpeval{2.346 * 10^{-3}}} % IК2 при UКЭ = 7 В, мА
\def\IkTwoUten   {\fpeval{2.457 * 10^{-3}}} % IК2 при UКЭ = 10 В, мА

% Строка IК3(при IБ3)
\def\IkThreeUoThree{\fpeval{3.633 * 10^{-3}}} % IК3 при UКЭ = 0.3 В, мА
\def\IkThreeUone   {\fpeval{3.704 * 10^{-3}}} % IК3 при UКЭ = 1 В, мА
\def\IkThreeUthree {\fpeval{3.832 * 10^{-3}}} % IК3 при UКЭ = 3 В, мА
\def\IkThreeUfive  {\fpeval{3.960 * 10^{-3}}} % IК3 при UКЭ = 5 В, мА
\def\IkThreeUseven {\fpeval{4.088 * 10^{-3}}} % IК3 при UКЭ = 7 В, мА
\def\IkThreeUten   {\fpeval{4.281 * 10^{-3}}} % IК3 при UКЭ = 10 В, мА

% Строка IК4(при IБ4)
\def\IkFourUoThree{\fpeval{5.201 * 10^{-3}}} % IК4 при UКЭ = 0.3 В, мА
\def\IkFourUone   {\fpeval{5.308 * 10^{-3}}} % IК4 при UКЭ = 1 В, мА
\def\IkFourUthree {\fpeval{5.492 * 10^{-3}}} % IК4 при UКЭ = 3 В, мА
\def\IkFourUfive  {\fpeval{5.675 * 10^{-3}}} % IК4 при UКЭ = 5 В, мА
\def\IkFourUseven {\fpeval{5.859 * 10^{-3}}} % IК4 при UКЭ = 7 В, мА
\def\IkFourUten   {\fpeval{6.136 * 10^{-3}}} % IК4 при UКЭ = 10 В, мА

% Строка IК5(при IБ5)
\def\IkFiveUoThree{\fpeval{6.773 * 10^{-3}}} % IК5 при UКЭ = 0.3 В, мА
\def\IkFiveUone   {\fpeval{6.922 * 10^{-3}}} % IК5 при UKЭ = 1 В, мА
\def\IkFiveUthree {\fpeval{7.162 * 10^{-3}}} % IК5 при UКЭ = 3 В, мА
\def\IkFiveUfive  {\fpeval{7.401 * 10^{-3}}} % IК5 при UКЭ = 5 В, мА
\def\IkFiveUseven {\fpeval{7.642 * 10^{-3}}} % IК5 при UКЭ = 7 В, мА
\def\IkFiveUten   {\fpeval{8.001 * 10^{-3}}} % IК5 при UКЭ = 10 В, мА
...
\def\IbOne  {\fpeval{6.661 * 10^{-6}}} % IБ1, А
\def\IbTwo  {\fpeval{19.429 * 10^{-6}}} % IБ2, А
\def\IbThree{\fpeval{32.307 * 10^{-6}}} % IБ3, А
\def\IbFour {\fpeval{45.408 * 10^{-6}}} % IБ4, А
\def\IbFive {\fpeval{58.731 * 10^{-6}}} % IБ5, А
% Впишите измеренные UБЭ при UКЭ = 5 В
% Порядок должен соответствовать IБ1 ... IБ5
\def\UbeOne  {\fpeval{596.814 * 10^{-3}}} % UБЭ1, В
\def\UbeTwo  {\fpeval{628.410 * 10^{-3}}} % UБЭ2, В
\def\UbeThree{\fpeval{643.311 * 10^{-3}}} % UБЭ3, В
\def\UbeFour {\fpeval{653.162 * 10^{-3}}} % UБЭ4, В
\def\UbeFive {\fpeval{660.565 * 10^{-3}}} % UБЭ5, В
...
\def\UziOne  {\fpeval{333.333 * 10^{-9}}} % первая промежуточная точка UЗИ = 0, В
\def\UziTwo  {\fpeval{593.666 * 10^{-3}}} % вторая промежуточная точка UЗИ = 0.6, В
\def\UziThree{\fpeval{  1.187}} % третья промежуточная точка UЗИ = 1.2, В
\def\UziFour {\fpeval{  1.781}} % четвёртая промежуточная точка UЗИ = 1.8, В
\def\UziFive {\fpeval{  2.420}} % пятая промежуточная точка UЗИ = 2.4, В
\def\Uots    {\fpeval{  2.896}} % напряжение отсечки Uотс, В

% Впишите соответствующие токи стока IС
\def\IcSat  {\fpeval{  7.523 * 10^{-3}}} % IС.нас при UЗИ = 0, А
\def\IcTwo  {\fpeval{  4.771 * 10^{-3}}} % IС при UЗИ = UziTwo, А
\def\IcThree{\fpeval{  2.641 * 10^{-3}}} % IС при UЗИ = UziThree, А
\def\IcFour {\fpeval{  1.136 * 10^{-3}}} % IС при UЗИ = UziFour, А
\def\IcFive {\fpeval{214.051 * 10^{-6}}} % IС при UЗИ = UziFive, А
\def\IcCut  {\fpeval{  0}} % IС при UЗИ = Uотс, А (обычно близко к 0)
...
% ---------------------------------------------------------
% IС при UЗИ = 0
\def\IcUziZeroOne  {\fpeval{4.157 * 10^{-3}}} % при UСИ = 1 В
\def\IcUziZeroTwo  {\fpeval{6.645 * 10^{-3}}} % при UСИ = 2 В
\def\IcUziZeroThree{\fpeval{7.426 * 10^{-3}}} % при UСИ = 3 В
\def\IcUziZeroFour {\fpeval{7.474 * 10^{-3}}} % при UСИ = 4 В
\def\IcUziZeroSix  {\fpeval{7.572 * 10^{-3}}} % при UСИ = 6 В
\def\IcUziZeroEight{\fpeval{7.670 * 10^{-3}}} % при UСИ = 8 В
\def\IcUziZeroTen  {\fpeval{7.766 * 10^{-3}}} % при UСИ = 10 В

% IС при UЗИ = Uотс / 2
\def\IcUziHalfOne  {\fpeval{1.662 * 10^{-3}}} % при UСИ = 1 В
\def\IcUziHalfTwo  {\fpeval{1.858 * 10^{-3}}} % при UСИ = 2 В
\def\IcUziHalfThree{\fpeval{1.871 * 10^{-3}}} % при UСИ = 3 В
\def\IcUziHalfFour {\fpeval{1.883 * 10^{-3}}} % при UСИ = 4 В
\def\IcUziHalfSix  {\fpeval{1.908 * 10^{-3}}} % при UСИ = 6 В
\def\IcUziHalfEight{\fpeval{1.933 * 10^{-3}}} % при UСИ = 8 В
\def\IcUziHalfTen  {\fpeval{1.956 * 10^{-3}}} % при UСИ = 10 В
...
\fancyhead[R]{Электроника}
\fancyfoot[C]{\thepage}

\section*{Цель работы}
Исследование биполярных и полевых транзисторов.

\fancyhead[L]{Электрическая схема к $1$-$4$-ому заданиям} 
...
\begin{tabularx}{\textwidth}{|p{3cm}|C|C|C|C|C|}
	...
	\hline
\end{tabularx}
\caption{Токи базы $I_\text{Б}$ и напряжения база-эмиттер $U_\text{БЭ}$ при $U_\text{КЭ}=5$ В}
\end{table}
...
\fancyhead[L]{Электрическая схема к $5$-$8$-ому заданиям} 
...
\centering
\small
\begin{tabularx}{\textwidth}{|p{1.1cm}|p{2.3cm}|p{2.3cm}|C|C|p{2.3cm}|p{2.3cm}|}
	\hline
	...
	\hline
	$I_\text{С}$, мА & \centering $I_\text{C.нас} = \fpeval{\IcSat * 10^{3}}$ & \centering $\fpeval{\IcTwo * 10^{3}}$ & $\fpeval{\IcThree * 10^{3}}$ & $\fpeval{\IcFour * 10^{3}}$ & $\fpeval{\IcFive * 10^{6}} \cdot 10^{-3}$ & $I_\text{С}=\fpeval{\IcCut}$ \\
	\hline
\end{tabularx}
