...
\begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}[t]{0.7\textwidth}
            ...
            \begin{equation*}
                \begin{matrix}
                    n_0 = \frac{10^{14} - \sqrt{\left(10^{14}\right)^2 + 4 \cdot \left(1.45 \cdot 10^{10}\right)^2}}{2} = \luaexec{tex.sprint(value_with_mantice((10^(14) - ((10^(14))^2 + 4 * (1.45 * 10^(10))^2)^(0.5)) / 2, 5, 0, 0))} & p_0 = \frac{{n_i}^2}{n_0} \\
                    n_0 = \frac{10^{14} + \sqrt{\left(10^{14}\right)^2 + 4 \cdot \left(1.45 \cdot 10^{10}\right)^2}}{2} = \luaexec{tex.sprint(value_with_mantice((10^(14) + ((10^(14))^2 + 4 * (1.45 * 10^(10))^2)^(0.5)) / 2, 5, 0, 0))} & p_0 = \frac{\left(1.45 \cdot 10^{10}\right)^2}{10^{14}}=\luaexec{tex.sprint(value_with_mantice(((1.45 * 10^(10))^2)/(10^(14)), 3, 0, 0))}
                \end{matrix}
            \end{equation*}
        \end{minipage}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{minipage}[t]{0.3\textwidth}
            ...
            \begin{equation*}
                ...
                \end{aligned}
            \end{equation*}
            Ответ: концентрация электронов $n_0 = \luaexec{tex.sprint(value_with_mantice((10 ^ 14 + ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2, 5, 0, 0))}$ и дырок $p_0 = \luaexec{tex.sprint(value_with_mantice(((2.4 * 10^(13))^2)/((10 ^ 14 + ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2), 3, 0, 0))}$.
        \end{minipage}
        \begin{minipage}[t]{0.7\textwidth}
            \vspace{0em}
            \includegraphics[width=\linewidth]{image/Illustration3.png}
            ...
            \begin{equation*}
                \begin{aligned}
                    n_0 = \frac{10^{14} - \sqrt{\left(10^{14}\right)^2 + 4 \cdot \left(2.4 \cdot 10^{13}\right)^2}}{2} = \luaexec{tex.sprint(value_with_mantice((10 ^ 14 - ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2, 5, 0, 0))} \\
                    n_0 = \frac{10^{14} + \sqrt{\left(10^{14}\right)^2 + 4 \cdot \left(2.4 \cdot 10^{13}\right)^2}}{2} = \luaexec{tex.sprint(value_with_mantice((10 ^ 14 + ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2, 5, 0, 0))} 
                \end{aligned}
            \end{equation*}
            концентрация дырок ищется из концентрации электронов
            \begin{equation*}
                p_0 = \frac{{n_i}^2}{n_0} \qquad p_0 = \frac{\left(2.4 \cdot 10^{13}\right)^2}{\luaexec{tex.sprint(value_with_mantice((10 ^ 14 + ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2, 5, 0, 0))}}=\luaexec{tex.sprint(value_with_mantice(((2.4 * 10^(13))^2)/((10 ^ 14 + ((10 ^ 14) ^ 2 + 4 * (2.4 * 10^(13))^2)^(0.5)) / 2), 3, 0, 0))}
            \end{equation*}
        \end{minipage}
    \end{figure}
