		...
		if (!pistonHandler.calculatePush()) {
			...
			if (retract) {
				...
				BlockState blockState2 = Blocks.MOVING_PISTON
					...
					.with(PistonExtensionBlock.TYPE, this.sticky ? PistonType.STICKY : PistonType.DEFAULT);
				map.remove(blockPos);
				world.setBlockState(blockPos, blockState2, Block.MOVED | Block.NO_REDRAW);
			...
			for (BlockPos blockPos4 : map.keySet()) {
				world.setBlockState(blockPos4, blockState5, Block.FORCE_STATE | Block.MOVED | Block.NOTIFY_LISTENERS);
			}
