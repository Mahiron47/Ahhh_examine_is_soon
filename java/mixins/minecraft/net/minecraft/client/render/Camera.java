...
public class Camera {
	...
	public void update(BlockView area, Entity focusedEntity, boolean thirdPerson, boolean inverseView, float tickDelta) {
		...
		this.setPos(
			...
			MathHelper.lerp((double)tickDelta, focusedEntity.prevY, focusedEntity.getY()) + MathHelper.lerp(tickDelta, this.lastCameraY, this.cameraY),
	...
	private double clipToSpace(double desiredCameraDistance) {
		for (int i = 0; i < 8; i++) {
			...
			g *= 0.1F;
			h *= 0.1F;
			Vec3d vec3d = this.pos.add(f, g, h);
			Vec3d vec3d2 = new Vec3d(
				this.pos.x - this.horizontalPlane.x() * desiredCameraDistance + f,
				this.pos.y - this.horizontalPlane.y() * desiredCameraDistance + g,
				this.pos.z - this.horizontalPlane.z() * desiredCameraDistance + h
			);
